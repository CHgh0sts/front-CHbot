...
const OPTIONAL_COMP: Partial<Record<BotRoleKey, keyof CompositionConfigJson>> = {
  ...
  WHITE_WEREWOLF: 'includeWhiteWerewolf',
  PIED_PIPER: 'includePiedPiper',
  ...
  DOCTEUR: 'includeDocteur',
  NECROMANCER: 'includeNecromancer',
  SECTARIAN: 'includeSectarian',
  DEVOTED_SERVANT: 'includeDevotedServant',
  INFECT_FATHER: 'includeInfectFather',
  DOG_WOLF: 'includeDogWolf',
  DICTATEUR: 'includeDictateur',
  HACKEUR: 'includeHackeur',
};
